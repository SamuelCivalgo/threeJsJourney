...
function resetCamera() {
    gsap.to(camera.position, {
        ...
        y: 0, 
        z: 3, 
        onUpdate: () => camera.updateProjectionMatrix() // update the camera's matrix on each frame
    });
    ...
    gsap.to(camera.rotation, {
        ...
        y: mesh.rotation.y,
        z: mesh.rotation.z,
        onUpdate: () => camera.lookAt(mesh.position) // update the camera's lookAt on each frame
    });
